...
export const REEL_POSTS: ReelPost[] = [
  ...
  },
  {
    ...
    caption: 'We swapped our hotel for the Cedar Geodesic Dome in Old Manali using @himachal.nomad package customizer. Waking up to this 360-degree snow view was the best decision ever! ☕❄️',
